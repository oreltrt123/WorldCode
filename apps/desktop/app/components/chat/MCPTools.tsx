...
import McpServerList from '~/components/@settings/mcp/McpServerList';
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-end items-center mb-2">
                    ...
                    >
                      {isCheckingServers ? (
                        <div className="i-svg-spinners:90-ring-with-bg w-3 h-3 text-codinit-elements-loader-progress animate-spin" />
                      ) : (
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-codinit-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-codinit-elements-icon-error">{error}</p>}</div>
              </div>
